...
PLEASE NOTE: Though EavesDrop is in an offical release state, some of the embedded libraries it uses are still in beta. Non-enUS clients may have errors or strange behavior. 
